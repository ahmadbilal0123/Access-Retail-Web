    ...
    <>
      ...
      <section className="bg-[#001333] py-12 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6 md:px-8">
        <div className="container mx-auto max-w-3xl">
          ...
          <motion.div
            ...
            className="bg-[#1a2d3d] rounded-lg p-4 sm:p-6 md:p-8 max-w-2xl mx-auto"
          >
      ...
      <section className="bg-[#001333] py-12 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6 md:px-8 border-t border-blue-900/30">
        <div className="container mx-auto max-w-3xl">
          ...
          {/* Icon and paragraph in a row */}
          <div className="flex flex-col md:flex-row items-center md:items-center gap-6 mb-8" ref={valuesRef}>
            {/* Circle icon - left side on desktop, centered on mobile */}
            <motion.div
              initial={{ opacity: 0, x: -20 }}
